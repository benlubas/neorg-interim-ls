...
module.private.handlers = {
    ...
    ["textDocument/rename"] = function(params, _callback, _notify_reply_callback)
        module.public.rename_heading(params.position.line + 1, params.newName)
    end,
}
...
module.private.start_lsp = function()
    ...
    vim.lsp.start({
            ...
            local members = {
                ...
                request = function(method, params, callback, notify_reply_callback)
                    if module.private.handlers[method] then
                        module.private.handlers(params, callback, notify_reply_callback)
                    else
        ...
        on_init = function(_client, _init_result) end,
